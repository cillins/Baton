...
export default function SettingsPane({ version = '0.1.0 (1)' }) {
  return (
    <div className="pane">
      ...
      <div className="group">
        ...
        <div className="kv"><span className="k">自动检查更新</span><Switch label="自动检查更新" /></div>
      </div>
      ...
      <div className="group">
        ...
        <div className="card-foot" style={{ display: 'flex', justifyContent: 'flex-end', gap: 8 }}>
          <button className="abtn abtn-ghost">检查更新</button>
          <button className="abtn">查看帮助</button>
        </div>
      </div>
    </div>
  )
