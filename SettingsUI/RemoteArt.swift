...
//  SVG strings are copied verbatim from web/src/art.js so designers can diff
//  byte-for-byte. The parser supports the subset of SVG the original art
...
/// Public entry points - keyed by the same `gen1` / `gen2` tags the React side uses.
...
/// Raw SVG strings - copied verbatim from web/src/art.js.
